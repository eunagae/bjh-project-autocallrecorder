...
import kr.bae.autocallrecoder.PreferencesActivity;
...
public class MyFragmentFirst extends Fragment{
	...
	public MyFragmentFirst(MyFragmentPagerAdapter fragmentAdapter, Context context) {
	...
	private void deleteRecordFile(String phoneNumber) {
		...
		String dir = file.getAbsolutePath() + "/AutoCallRecorder/"
				+ phoneNumber;
		File f = new File(dir);
		if (f.exists()) {
			...
			for (File childFile : childFileList) {
				if (childFile.isDirectory()) {
					deleteRecordFile(childFile.getAbsolutePath()); // 하위
				} else {
	...
	private void deleteListData(String phoneNumber) {
		dao.updateGroupVisible(phoneNumber);
