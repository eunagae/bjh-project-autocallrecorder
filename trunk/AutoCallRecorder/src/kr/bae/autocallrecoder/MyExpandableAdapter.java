...
import kr.bae.autocallrecoder.radialmenu.RadialMenu;
import kr.bae.autocallrecoder.recorder.RecordPlayer;
...
public class MyExpandableAdapter extends BaseExpandableListAdapter {
    ...
    private RecordPlayer mRecordPlay;
	...
	// constructor
	public MyExpandableAdapter(List<GroupItem> listDataHeader,
	...
	public RecordPlayer getmRecordPlay() {
		return mRecordPlay;
	}
	...
	/*public void setInflater(LayoutInflater inflater, FragmentActivity context, View v) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		convertView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				mRadialMenu = new RadialMenu(mContext, MyExpandableAdapter.this, fragmentAdapter);
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (recBar.getVisibility() == View.GONE) {
					...
					mRecordPlay = new RecordPlayer(phoneNum, fileName);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		//TextView subTitleTv = (TextView) convertView.findViewById(R.id.sub_phone_id);
		//subTitleTv.setText(item.getmName());
		...
		iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				animation.setAnimationListener(new MyAnimationListener(iv));
...
/*	public void removeGroup(Set<Integer> positions) {
		for (Integer pos : positions) {
			mListDataHeader.remove(pos);
			clearSelection();
		}		
		notifyDataSetChanged();
	}*/
